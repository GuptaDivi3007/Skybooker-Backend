...
import com.skybooker.auth.dto.ApiErrorResponse;
...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler({UnauthorizedException.class, TokenException.class})
    @ResponseStatus(HttpStatus.UNAUTHORIZED)
    public ApiErrorResponse handleUnauthorized(RuntimeException ex, HttpServletRequest request) {
        return new ApiErrorResponse(
                LocalDateTime.now(),
